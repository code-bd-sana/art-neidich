              ...
              <tbody className="divide-y divide-gray-200">
                {adminlist.map((admin) => (
                  <tr key={admin.id} className="hover:bg-gray-50 transition-colors">
                    ...
                    <td className="py-4 px-6">
                      <button
                        className={`py-1.5 text-sm flex gap-x-2 items-center rounded-lg transition-colors ${admin.actionColor}`}
                      >
                        {admin.action} {admin.action === "Approve" ? <Check className=" text-teal-600"/> : <Trash className="text-sm text-red-500"/>}
                      </button>
                    </td>
                  </tr>
                ))}
